...
| 기      타 :
*----------------------------------------*/
// IndexOptSiseDlg.cpp : 구현 파일입니다.
//

#include "stdafx.h"
#include "HFCommClient.h"
#include "IndexWeeklyOptSiseDlg.h"
...
// CWeeklyIndexOptSiseDlg 대화 상자
CWeeklyIndexOptSiseDlg::CWeeklyIndexOptSiseDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CWeeklyIndexOptSiseDlg::IDD, pParent)
{
...
#ifdef WEEKLY_OPTION_TEST
    m_strLoginID = "PKI008";
#endif
}

void CWeeklyIndexOptSiseDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CWeeklyIndexOptSiseDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_DESTROY()
	ON_WM_QUERYDRAGICON()
	...
	ON_WM_TIMER()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(ID_LOGIN, &CWeeklyIndexOptSiseDlg::OnBnClickedLogin)
	ON_BN_CLICKED(ID_LOGOUT, &CWeeklyIndexOptSiseDlg::OnBnClickedLogout)
	ON_BN_CLICKED(IDC_INITCOMM, &CWeeklyIndexOptSiseDlg::OnBnClickedInitcomm)
	ON_BN_CLICKED(IDC_TERMINATE, &CWeeklyIndexOptSiseDlg::OnBnClickedTerminate)
	ON_BN_CLICKED(IDC_BTN_REQ_HOGA, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqHoga)
	ON_BN_CLICKED(IDC_BTN_REQ_PRICE, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqPrice)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqTick)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK_NEXT, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqTickNext)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqCodeList)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST_NEXT, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqCodeListNext)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST_SYMBOL, &CWeeklyIndexOptSiseDlg::OnNMDblclkListSymbol)
	ON_BN_CLICKED(IDOK, &CWeeklyIndexOptSiseDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqChart)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART_NEXT, &CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqChartNext)
	ON_COMMAND_RANGE(IDC_RADIO_TICK, IDC_RADIO_MON, &CWeeklyIndexOptSiseDlg::OnRadioChartTerm)
	ON_COMMAND_RANGE(IDC_CON_REAL, IDC_CON_F_DEMO, &CWeeklyIndexOptSiseDlg::OnRdoSelectServer)
END_MESSAGE_MAP()

// agent로부터 이벤트 수신 함수를 정의한다.
BEGIN_EVENTSINK_MAP(CWeeklyIndexOptSiseDlg, CDialog)
	ON_EVENT(CWeeklyIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 1, CWeeklyIndexOptSiseDlg::OnGetTranData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CWeeklyIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 2, CWeeklyIndexOptSiseDlg::OnGetFidData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CWeeklyIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 3, CWeeklyIndexOptSiseDlg::OnGetRealData, VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4)
END_EVENTSINK_MAP()

// CWeeklyIndexOptSiseDlg 메시지 처리기

void CWeeklyIndexOptSiseDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CWeeklyIndexOptSiseDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CWeeklyIndexOptSiseDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CWeeklyIndexOptSiseDlg::OnRdoSelectServer(UINT nID)
{
...
HBRUSH CWeeklyIndexOptSiseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CWeeklyIndexOptSiseDlg::OnDestroy()
{
	//모든 실시간등록을 해제한다.
...
void CWeeklyIndexOptSiseDlg::OnClose()
{
...
void CWeeklyIndexOptSiseDlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CWeeklyIndexOptSiseDlg::OnNMDblclkListSymbol(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	*pResult = 0;
	...
	OnBnClickedBtnReqPrice();	//지수옵션 현재가 조회
	OnBnClickedBtnReqHoga();	//지수옵션 5단계호가 조회
	OnBnClickedBtnReqTick();	//지수옵션 시간대별체결 조회
	OnBnClickedBtnReqChart();	//지수옵션 차트데이터 조회
}

void CWeeklyIndexOptSiseDlg::OnRadioChartTerm(UINT nID)
{
	CString strCaption;
...
// Comment       : 
//******************************************************************
BOOL CWeeklyIndexOptSiseDlg::OnInitDialog()
{
	...
	CString strTitle;
	strTitle.Format("%s-[위클리옵션 시세](%s)", PROGRAM_NAME, VERSION_INFO);
	...
	**********************************/
//#if 0
    //지수옵션체결 실시간 I/O 정보 리소스 파일
	if (!m_CommAgent.LoadRealResource(strApidAgentModulePath + "/RealRes/O40.res"))
		::AfxMessageBox(m_CommAgent.GetLastErrMsg());

	//지수옵션호가 실시간 I/O 정보 리소스 파일
	if (!m_CommAgent.LoadRealResource(strApidAgentModulePath + "/RealRes/O41.res"))
		::AfxMessageBox(m_CommAgent.GetLastErrMsg());
//#endif
...
// Function      : 지수옵션 시간대별체결 리스트 컨트롤 초기화
// Param         : 
// Return        : void 
// Create        :
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::InitListTick()
{
	CRect rc;
...
// Function      : 지수옵션 종목 리스트 컨트롤 초기화
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::InitListCode()
{
	int arrWidth[6] = { 0x00 };
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::InitListChart()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
CString CWeeklyIndexOptSiseDlg::GetDiffSign(CString strSignCode)
{
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::SetHogaData(CString* arrSellHoga, CString* arrBuyHoga, CString* arrSellRemain,
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedInitcomm()
{
	if (m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedTerminate()
{
	if (!m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedLogin()
{
	//로그인 ID
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedLogout()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Function      : 지수옵션 종목 리스트 조회
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqCodeList()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
	...
	**********************************/
	...
	(1773)거래승수,	(2624)실시간가격제한여부*/
	strOutputFidList = "1,2,3,1373,1773,2624";
...
// Function      : 지수옵션 종목 리스트 다음 조회
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqCodeListNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqPrice()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
	...
	**********************************/
	...
	/**********************************
	* 2. 이전에 등록된 지수옵션체결(현재가) 실시간등록 해제.
	**********************************/
	if (!m_strCurPriceRealKey.IsEmpty())
	{
		CString strRealName;
		strRealName = _T("O40"); //지수옵션체결 Real name
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqHoga()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Function      : 지수옵션 시간대별체결 데이터 조회(연속거래 데이터가 있는 경우)
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqTick()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Function      : 지수옵션 시간대별체결 다음 데이터 조회
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqTickNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Function      : 지수옵션 차트 데이터 조회
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqChart()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Function      : 지수옵션 차트 다음 데이터 조회
// Param         : 
// Return        : void 
// Create        : 
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnBnClickedBtnReqChartNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
void CWeeklyIndexOptSiseDlg::OnBnClickedOk()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnGetTranData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnGetFidData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
	...
	/***************************************
	* 지수옵션 종목 리스트(마스터) 조회 데이터 수신 처리
	****************************************/
	if (m_nRqIdCodeList == nRequestId)
	{
		CString arrItemValue[6];
		...
		---------------------------------------*/
		m_nRqIdCodeList = 0;	//지수옵션 종목 리스트(마스터) 조회 Request ID
	}
	/***************************************
	* 지수옵션 5단계호가 조회 데이터 수신 처리
	****************************************/
	else if (m_nRqIdHoga == nRequestId)
	{
		...
		반드시 사용이 끝난 RQ ID는 0으로 초기화한다.
		---------------------------------------*/
		m_nRqIdHoga = 0;	//지수옵션 5단계호가 조회 Request ID
	}
	/***************************************
	* 지수옵션 현재가 조회 데이터 수신 처리
	****************************************/
	else if (m_nRqIdCurPrice == nRequestId)
	{
		...
		반드시 사용이 끝난 RQ ID는 0으로 초기화한다.
		---------------------------------------*/
		m_nRqIdCurPrice = 0;	//지수옵션 현재가 조회 Request ID
	}
	/***************************************
	* 지수옵션 시간대별체결 조회 데이터 수신 처리
	****************************************/
	else if (m_nRqIdTick == nRequestId)
	{
		...
		반드시 사용이 끝난 RQ ID는 0으로 초기화한다.
		---------------------------------------*/
		m_nRqIdTick = 0;	//지수옵션 시간대별체결 조회 Request ID

	}
	/***************************************
	* 지수옵션 차트 조회 데이터 수신 처리
	****************************************/
	else if (m_nRqIdChart == nRequestId)
	{
		...
		****************************************/
		...
		반드시 사용이 끝난 RQ ID는 0으로 초기화한다.
		---------------------------------------*/
		m_nRqIdChart = 0;	//지수옵션 종목 리스트(마스터) 조회 Request ID
...
// Comment       : 
//******************************************************************
void CWeeklyIndexOptSiseDlg::OnGetRealData(LPCTSTR strRealName, LPCTSTR strRealKey, LPCTSTR pBlock, long nBlockLength)
{
	...
	* 지수옵션 호가 실시간 데이터 수신
	****************************************/
	if (!_tcscmp(strRealName, "O41"))
	{
		/*--------------------------------------
		조회 시점에 등록한 지수옵션 호가 실시간키와 동일한지 비교
		---------------------------------------*/
	...
	/***************************************
	* 지수옵션 체결(현재가) 실시간 데이터 수신
	****************************************/
	else if (!_tcscmp(strRealName, "O40"))
	{
		/*--------------------------------------
		아이템명으로 수신될 실시간 데이터를 항목별로 빼낸다.
		---------------------------------------*/
		...
		/*--------------------------------------
		조회 시점에 등록한 지수옵션 현재가 실시간키와 동일한지 비교
		---------------------------------------*/
		...
		/*--------------------------------------
		조회 시점에 등록한 지수옵션 시간대별 체결 실시간키와 동일한지 비교
		---------------------------------------*/
