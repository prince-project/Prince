...
// CIndexFutSiseDlg 대화 상자
CIndexFutSiseDlg::CIndexFutSiseDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIndexFutSiseDlg::IDD, pParent)
{
...
void CIndexFutSiseDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CHECK_JF, m_ctrlEquityFuture);
}

BEGIN_MESSAGE_MAP(CIndexFutSiseDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_DESTROY()
	ON_WM_QUERYDRAGICON()
	...
	ON_WM_TIMER()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(ID_LOGIN, &CIndexFutSiseDlg::OnBnClickedLogin)
	ON_BN_CLICKED(ID_LOGOUT, &CIndexFutSiseDlg::OnBnClickedLogout)
	ON_BN_CLICKED(IDC_INITCOMM, &CIndexFutSiseDlg::OnBnClickedInitcomm)
	ON_BN_CLICKED(IDC_TERMINATE, &CIndexFutSiseDlg::OnBnClickedTerminate)
	ON_BN_CLICKED(IDC_BTN_REQ_HOGA, &CIndexFutSiseDlg::OnBnClickedBtnReqHoga)
	ON_BN_CLICKED(IDC_BTN_REQ_PRICE, &CIndexFutSiseDlg::OnBnClickedBtnReqPrice)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK, &CIndexFutSiseDlg::OnBnClickedBtnReqTick)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK_NEXT, &CIndexFutSiseDlg::OnBnClickedBtnReqTickNext)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST, &CIndexFutSiseDlg::OnBnClickedBtnReqCodeList)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST_NEXT, &CIndexFutSiseDlg::OnBnClickedBtnReqCodeListNext)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST_SYMBOL, &CIndexFutSiseDlg::OnNMDblclkListSymbol)
	ON_BN_CLICKED(IDOK, &CIndexFutSiseDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART, &CIndexFutSiseDlg::OnBnClickedBtnReqChart)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART_NEXT, &CIndexFutSiseDlg::OnBnClickedBtnReqChartNext)
	ON_COMMAND_RANGE(IDC_RADIO_TICK, IDC_RADIO_MON, &CIndexFutSiseDlg::OnRadioChartTerm)
	ON_COMMAND_RANGE(IDC_CON_REAL, IDC_CON_F_DEMO, &CIndexFutSiseDlg::OnRdoSelectServer)
	ON_BN_CLICKED(IDC_CHECK_JF, &CIndexFutSiseDlg::OnBnClickedCheckJf)
END_MESSAGE_MAP()

// agent로부터 이벤트 수신 함수를 정의한다.
BEGIN_EVENTSINK_MAP(CIndexFutSiseDlg, CDialog)
	ON_EVENT(CIndexFutSiseDlg, IDC_HFCOMMAGENTCTRL1, 1, CIndexFutSiseDlg::OnGetTranData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CIndexFutSiseDlg, IDC_HFCOMMAGENTCTRL1, 2, CIndexFutSiseDlg::OnGetFidData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CIndexFutSiseDlg, IDC_HFCOMMAGENTCTRL1, 3, CIndexFutSiseDlg::OnGetRealData, VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4)
END_EVENTSINK_MAP()

// CIndexFutSiseDlg 메시지 처리기

void CIndexFutSiseDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CIndexFutSiseDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CIndexFutSiseDlg::OnRdoSelectServer(UINT nID)
{
...
HBRUSH CIndexFutSiseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CIndexFutSiseDlg::OnDestroy()
{
	//모든 실시간등록을 해제한다.
...
void CIndexFutSiseDlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CIndexFutSiseDlg::OnNMDblclkListSymbol(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CIndexFutSiseDlg::OnRadioChartTerm(UINT nID)
{
	CString strCaption;
...
// Comment       : 
//******************************************************************
BOOL CIndexFutSiseDlg::OnInitDialog()
{
	...
	**********************************/
	...
	if (!m_CommAgent.LoadRealResource(strApidAgentModulePath + "/RealRes/F00.res"))
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::InitListTick()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::InitListCode()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::InitListChart()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
CString CIndexFutSiseDlg::GetDiffSign(CString strSignCode)
{
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::SetHogaData(CString* arrSellHoga, CString* arrBuyHoga, CString* arrSellRemain,
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedInitcomm()
{
	if (m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedTerminate()
{
	if (!m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedLogin()
{
	//로그인 ID
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedLogout()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqCodeList()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
	...
	**********************************/
	...
	if(m_ctrlEquityFuture.GetCheck())
		strMarketCode = _T("JF");	// 주식선물
	else
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqCodeListNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqPrice()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqHoga()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqTick()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqTickNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqChart()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnBnClickedBtnReqChartNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
void CIndexFutSiseDlg::OnBnClickedOk()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnGetTranData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnGetFidData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
...
// Comment       : 
//******************************************************************
void CIndexFutSiseDlg::OnGetRealData(LPCTSTR strRealName, LPCTSTR strRealKey, LPCTSTR pBlock, long nBlockLength)
{
...
void CIndexFutSiseDlg::OnBnClickedCheckJf()
{
	OnBnClickedBtnReqCodeList(); //종목리스트(마스터) 조회
}
