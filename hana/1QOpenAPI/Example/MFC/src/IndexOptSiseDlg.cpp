...
// CIndexOptSiseDlg 대화 상자
CIndexOptSiseDlg::CIndexOptSiseDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIndexOptSiseDlg::IDD, pParent)
{
...
void CIndexOptSiseDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CIndexOptSiseDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_DESTROY()
	ON_WM_QUERYDRAGICON()
	...
	ON_WM_TIMER()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(ID_LOGIN, &CIndexOptSiseDlg::OnBnClickedLogin)
	ON_BN_CLICKED(ID_LOGOUT, &CIndexOptSiseDlg::OnBnClickedLogout)
	ON_BN_CLICKED(IDC_INITCOMM, &CIndexOptSiseDlg::OnBnClickedInitcomm)
	ON_BN_CLICKED(IDC_TERMINATE, &CIndexOptSiseDlg::OnBnClickedTerminate)
	ON_BN_CLICKED(IDC_BTN_REQ_HOGA, &CIndexOptSiseDlg::OnBnClickedBtnReqHoga)
	ON_BN_CLICKED(IDC_BTN_REQ_PRICE, &CIndexOptSiseDlg::OnBnClickedBtnReqPrice)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK, &CIndexOptSiseDlg::OnBnClickedBtnReqTick)
	ON_BN_CLICKED(IDC_BTN_REQ_TICK_NEXT, &CIndexOptSiseDlg::OnBnClickedBtnReqTickNext)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST, &CIndexOptSiseDlg::OnBnClickedBtnReqCodeList)
	ON_BN_CLICKED(IDC_BTN_REQ_CODE_LIST_NEXT, &CIndexOptSiseDlg::OnBnClickedBtnReqCodeListNext)
	ON_NOTIFY(NM_DBLCLK, IDC_LIST_SYMBOL, &CIndexOptSiseDlg::OnNMDblclkListSymbol)
	ON_BN_CLICKED(IDOK, &CIndexOptSiseDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART, &CIndexOptSiseDlg::OnBnClickedBtnReqChart)
	ON_BN_CLICKED(IDC_BTN_REQ_CHART_NEXT, &CIndexOptSiseDlg::OnBnClickedBtnReqChartNext)
	ON_COMMAND_RANGE(IDC_RADIO_TICK, IDC_RADIO_MON, &CIndexOptSiseDlg::OnRadioChartTerm)
	ON_COMMAND_RANGE(IDC_CON_REAL, IDC_CON_F_DEMO, &CIndexOptSiseDlg::OnRdoSelectServer)
END_MESSAGE_MAP()

// agent로부터 이벤트 수신 함수를 정의한다.
BEGIN_EVENTSINK_MAP(CIndexOptSiseDlg, CDialog)
	ON_EVENT(CIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 1, CIndexOptSiseDlg::OnGetTranData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 2, CIndexOptSiseDlg::OnGetFidData, VTS_I4 VTS_BSTR VTS_I4)
	ON_EVENT(CIndexOptSiseDlg, IDC_HFCOMMAGENTCTRL1, 3, CIndexOptSiseDlg::OnGetRealData, VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4)
END_EVENTSINK_MAP()

// CIndexOptSiseDlg 메시지 처리기

void CIndexOptSiseDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CIndexOptSiseDlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}

void CIndexOptSiseDlg::OnRdoSelectServer(UINT nID)
{
...
HBRUSH CIndexOptSiseDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
...
void CIndexOptSiseDlg::OnDestroy()
{
	//모든 실시간등록을 해제한다.
...
void CIndexOptSiseDlg::OnTimer(UINT_PTR nIDEvent)
{
...
void CIndexOptSiseDlg::OnNMDblclkListSymbol(NMHDR *pNMHDR, LRESULT *pResult)
{
...
void CIndexOptSiseDlg::OnRadioChartTerm(UINT nID)
{
	CString strCaption;
...
// Comment       : 
//******************************************************************
BOOL CIndexOptSiseDlg::OnInitDialog()
{
	...
	CString strTitle;
	strTitle.Format("%s-[지수옵션 시세](%s)", PROGRAM_NAME, VERSION_INFO);
	...
	**********************************/
	...
	if (!m_CommAgent.LoadRealResource(strApidAgentModulePath + "/RealRes/O00.res"))
		::AfxMessageBox(m_CommAgent.GetLastErrMsg());

	//지수옵션호가 실시간 I/O 정보 리소스 파일
	if (!m_CommAgent.LoadRealResource(strApidAgentModulePath + "/RealRes/O01.res"))
		::AfxMessageBox(m_CommAgent.GetLastErrMsg());
#endif
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::InitListTick()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::InitListCode()
{
	int arrWidth[6] = { 0x00 };
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::InitListChart()
{
	CRect rc;
...
// Comment       : 
//******************************************************************
CString CIndexOptSiseDlg::GetDiffSign(CString strSignCode)
{
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::SetHogaData(CString* arrSellHoga, CString* arrBuyHoga, CString* arrSellRemain,
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedInitcomm()
{
	if (m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedTerminate()
{
	if (!m_bCommConnect)
	{
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedLogin()
{
	//로그인 ID
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedLogout()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqCodeList()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqCodeListNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqPrice()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
	...
	**********************************/
	...
	{
		CString strRealName;
		strRealName = _T("O00"); //지수옵션체결 Real name
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqHoga()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqTick()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqTickNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqChart()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnBnClickedBtnReqChartNext()
{
	if (!m_bCommConnect)
	{
		::AfxMessageBox("통신 접속이 끊겼습니다!");
...
void CIndexOptSiseDlg::OnBnClickedOk()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnGetTranData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnGetFidData(LONG nRequestId, LPCTSTR pBlock, long nBlockLength)
{
...
// Comment       : 
//******************************************************************
void CIndexOptSiseDlg::OnGetRealData(LPCTSTR strRealName, LPCTSTR strRealKey, LPCTSTR pBlock, long nBlockLength)
{
	...
	****************************************/
	else if (!_tcscmp(strRealName, "O00"))
	{
		/*--------------------------------------
		아이템명으로 수신될 실시간 데이터를 항목별로 빼낸다.
		---------------------------------------*/
