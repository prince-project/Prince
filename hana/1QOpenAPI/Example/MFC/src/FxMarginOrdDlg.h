...
// CFxMarginOrdDlg 대화 상자입니다.
class CFxMarginOrdDlg : public CDialog
{
public:
	CFxMarginOrdDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
...
private:
	...
	int m_nRqIdCloseOrd;				//청산주문 Request ID
	int m_nRqIdModSLOrd;				//SL정정주문 Request ID
	int m_nRqIdCanSLOrd;				//SL취소주문 Request ID
...
public:
	...
	****************************************************/
	...
	BOOL SendSellBuyOrder(CString strDealingSide, int nRqId, CString strOrderKind = _T(""));	//매수/매도 주문 전송
