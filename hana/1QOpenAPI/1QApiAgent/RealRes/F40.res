BEGIN_FUNCTION_MAP
	REAL_TYPE=52, REAL_NAME=F40, DESCRIPTION=CME 선물 체결;
	BEGIN_DATA_MAP
	begin
 ...
 **********************************************/
CString strSHRN_ISCD = m_CommAgent.GetRealOutputData("F40", "SHRN_ISCD");		//종목 코드
CString strBSOP_DATE = m_CommAgent.GetRealOutputData("F40", "BSOP_DATE");		//실시간일자
CString strBSOP_HOUR = m_CommAgent.GetRealOutputData("F40", "BSOP_HOUR");		//체결 시간
CString strPRPR = m_CommAgent.GetRealOutputData("F40", "PRPR");		//현재가
CString strPRPR_CLR = m_CommAgent.GetRealOutputData("F40", "PRPR_CLR");		//[PRPR]색참조(+상승, -하락)
CString strPRDY_VRSS_SIGN = m_CommAgent.GetRealOutputData("F40", "PRDY_VRSS_SIGN");		//전일 대비 부호
CString strPRDY_VRSS = m_CommAgent.GetRealOutputData("F40", "PRDY_VRSS");		//전일 대비
CString strPRDY_VRSS_CLR = m_CommAgent.GetRealOutputData("F40", "PRDY_VRSS_CLR");		//[PRDY_VRSS]색참조(+상승, -하락)
CString strPRDY_CTRT = m_CommAgent.GetRealOutputData("F40", "PRDY_CTRT");		//전일 대비율
CString strPRDY_CTRT_CLR = m_CommAgent.GetRealOutputData("F40", "PRDY_CTRT_CLR");		//[PRDY_CTRT]색참조(+상승, -하락)
CString strCNTG_VOL = m_CommAgent.GetRealOutputData("F40", "CNTG_VOL");		//체결량
CString strCNTG_VOL_CLR = m_CommAgent.GetRealOutputData("F40", "CNTG_VOL_CLR");		//[CNTG_VOL]색참조(+상승, -하락)
CString strACML_VOL = m_CommAgent.GetRealOutputData("F40", "ACML_VOL");		//누적 거래량
CString strACML_TR_PBMN = m_CommAgent.GetRealOutputData("F40", "ACML_TR_PBMN");		//누적 거래 대금
CString strOPRC = m_CommAgent.GetRealOutputData("F40", "OPRC");		//시가
CString strOPRC_CLR = m_CommAgent.GetRealOutputData("F40", "OPRC_CLR");		//[OPRC]색참조(+상승, -하락)
CString strHGPR = m_CommAgent.GetRealOutputData("F40", "HGPR");		//고가
CString strHGPR_CLR = m_CommAgent.GetRealOutputData("F40", "HGPR_CLR");		//[HGPR]색참조(+상승, -하락)
CString strLWPR = m_CommAgent.GetRealOutputData("F40", "LWPR");		//저가
CString strLWPR_CLR = m_CommAgent.GetRealOutputData("F40", "LWPR_CLR");		//[LWPR]색참조(+상승, -하락)
CString strOPRC_HOUR = m_CommAgent.GetRealOutputData("F40", "OPRC_HOUR");		//시가 시간
CString strOPRC_VRSS_SIGN = m_CommAgent.GetRealOutputData("F40", "OPRC_VRSS_SIGN");		//시가 대비 부호
CString strOPRC_VRSS = m_CommAgent.GetRealOutputData("F40", "OPRC_VRSS");		//시가 대비
CString strOPRC_VRSS_CLR = m_CommAgent.GetRealOutputData("F40", "OPRC_VRSS_CLR");		//[OPRC_VRSS]색참조(+상승, -하락)
CString strHGPR_HOUR = m_CommAgent.GetRealOutputData("F40", "HGPR_HOUR");		//고가 시간
CString strHGPR_VRSS_SIGN = m_CommAgent.GetRealOutputData("F40", "HGPR_VRSS_SIGN");		//고가 대비 부호
CString strHGPR_VRSS = m_CommAgent.GetRealOutputData("F40", "HGPR_VRSS");		//고가 대비
CString strHGPR_VRSS_CLR = m_CommAgent.GetRealOutputData("F40", "HGPR_VRSS_CLR");		//[HGPR_VRSS]색참조(+상승, -하락)
CString strLWPR_HOUR = m_CommAgent.GetRealOutputData("F40", "LWPR_HOUR");		//저가 시간
CString strLWPR_VRSS_SIGN = m_CommAgent.GetRealOutputData("F40", "LWPR_VRSS_SIGN");		//저가 대비 부호
CString strLWPR_VRSS = m_CommAgent.GetRealOutputData("F40", "LWPR_VRSS");		//저가 대비
CString strLWPR_VRSS_CLR = m_CommAgent.GetRealOutputData("F40", "LWPR_VRSS_CLR");		//[LWPR_VRSS]색참조(+상승, -하락)
CString strNMSC_FCTN_STPL_PRC = m_CommAgent.GetRealOutputData("F40", "NMSC_FCTN_STPL_PRC");		//근월물 의제 약정가
CString strFMSC_FCTN_STPL_PRC = m_CommAgent.GetRealOutputData("F40", "FMSC_FCTN_STPL_PRC");		//원월물 의제 약정가
CString strSPEAD_PRC = m_CommAgent.GetRealOutputData("F40", "SPEAD_PRC");		//스프레드
CString strOTST_STPL_QTY = m_CommAgent.GetRealOutputData("F40", "OTST_STPL_QTY");		//미결제 약정 수량
CString strOTST_STPL_QTY_ICDC = m_CommAgent.GetRealOutputData("F40", "OTST_STPL_QTY_ICDC");		//미결제 약정 수량 증감
CString strOTST_STPL_QTY_ICDC_CLR = m_CommAgent.GetRealOutputData("F40", "OTST_STPL_QTY_ICDC_CLR");		//[OTST_STPL_QTY_ICDC]색참조(+상승, -하락)
CString strOTST_STPL_QTY_REF_IC = m_CommAgent.GetRealOutputData("F40", "OTST_STPL_QTY_REF_IC");		//미결제 약정 직전 수량 증감
CString strOTST_STPL_QTY_REF_IC_CLR = m_CommAgent.GetRealOutputData("F40", "OTST_STPL_QTY_REF_IC_CLR");		//[OTST_STPL_QTY_REF_IC]색참조(+상승, -하락)
CString strTHPR = m_CommAgent.GetRealOutputData("F40", "THPR");		//이론가
CString strTHPR_CLR = m_CommAgent.GetRealOutputData("F40", "THPR_CLR");		//[THPR]색참조(+상승, -하락)
CString strMRKT_BASIS = m_CommAgent.GetRealOutputData("F40", "MRKT_BASIS");		//시장 BASIS
CString strMRKT_BASIS_CLR = m_CommAgent.GetRealOutputData("F40", "MRKT_BASIS_CLR");		//[MRKT_BASIS]색참조(+상승, -하락)
CString strTHER_BASIS = m_CommAgent.GetRealOutputData("F40", "THER_BASIS");		//이론 BASIS
CString strTHER_BASIS_CLR = m_CommAgent.GetRealOutputData("F40", "THER_BASIS_CLR");		//[THER_BASIS]색참조(+상승, -하락)
CString strESDG = m_CommAgent.GetRealOutputData("F40", "ESDG");		//괴리도
CString strESDG_CLR = m_CommAgent.GetRealOutputData("F40", "ESDG_CLR");		//[ESDG]색참조(+상승, -하락)
CString strDPRT = m_CommAgent.GetRealOutputData("F40", "DPRT");		//괴리율
CString strDPRT_CLR = m_CommAgent.GetRealOutputData("F40", "DPRT_CLR");		//[DPRT]색참조(+상승, -하락)
CString strSHNU_RATE = m_CommAgent.GetRealOutputData("F40", "SHNU_RATE");		//매수비율
CString strSHNU_RATE_CLR = m_CommAgent.GetRealOutputData("F40", "SHNU_RATE_CLR");		//[SHNU_RATE]색참조(+상승, -하락)
CString strCTTR = m_CommAgent.GetRealOutputData("F40", "CTTR");		//체결강도
CString strCTTR_CLR = m_CommAgent.GetRealOutputData("F40", "CTTR_CLR");		//[CTTR]색참조(+상승, -하락)
CString strASKP1 = m_CommAgent.GetRealOutputData("F40", "ASKP1");		//매도호가1
CString strASKP1_CLR = m_CommAgent.GetRealOutputData("F40", "ASKP1_CLR");		//[ASKP1]색참조(+상승, -하락)
CString strBIDP1 = m_CommAgent.GetRealOutputData("F40", "BIDP1");		//매수호가1
CString strBIDP1_CLR = m_CommAgent.GetRealOutputData("F40", "BIDP1_CLR");		//[BIDP1]색참조(+상승, -하락)
CString strASKP_RSQN1 = m_CommAgent.GetRealOutputData("F40", "ASKP_RSQN1");		//매도호가 잔량
CString strBIDP_RSQN1 = m_CommAgent.GetRealOutputData("F40", "BIDP_RSQN1");		//매수호가 잔량
CString strSELN_CNTG_CSNU = m_CommAgent.GetRealOutputData("F40", "SELN_CNTG_CSNU");		//매도 체결 건수
CString strSHNU_CNTG_CSNU = m_CommAgent.GetRealOutputData("F40", "SHNU_CNTG_CSNU");		//매수 체결 건수
CString strNTBY_CNTG_CSNU = m_CommAgent.GetRealOutputData("F40", "NTBY_CNTG_CSNU");		//순매수 체결 건수
CString strNTBY_CNTG_CSNU_CLR = m_CommAgent.GetRealOutputData("F40", "NTBY_CNTG_CSNU_CLR");		//[NTBY_CNTG_CSNU]색참조(+상승, -하락)
CString strSELN_CNTG_SMTN = m_CommAgent.GetRealOutputData("F40", "SELN_CNTG_SMTN");		//매도 체결 합계
CString strSHNU_CNTG_SMTN = m_CommAgent.GetRealOutputData("F40", "SHNU_CNTG_SMTN");		//매수 체결 합계
CString strTOTAL_ASKP_RSQN = m_CommAgent.GetRealOutputData("F40", "TOTAL_ASKP_RSQN");		//총 매도호가 잔량
CString strTOTAL_BIDP_RSQN = m_CommAgent.GetRealOutputData("F40", "TOTAL_BIDP_RSQN");		//총 매수호가 잔량
CString strPRDY_VRSS_VOL_RATE = m_CommAgent.GetRealOutputData("F40", "PRDY_VRSS_VOL_RATE");		//전일 대비 거래량 비율
CString strPRDY_VRSS_VOL_RATE_CLR = m_CommAgent.GetRealOutputData("F40", "PRDY_VRSS_VOL_RATE_CLR");		//[PRDY_VRSS_VOL_RATE]색참조(+상승, -하락)
CString strUNAS_PRC = m_CommAgent.GetRealOutputData("F40", "UNAS_PRC");		//기초자산 가격
CString strUNAS_PRC_CLR = m_CommAgent.GetRealOutputData("F40", "UNAS_PRC_CLR");		//[UNAS_PRC]색참조(+상승, -하락)
CString strUNAS_PRDY_VRSS_SIGN = m_CommAgent.GetRealOutputData("F40", "UNAS_PRDY_VRSS_SIGN");		//기초자산 전일대비구분
CString strUNAS_PRDY_VRSS = m_CommAgent.GetRealOutputData("F40", "UNAS_PRDY_VRSS");		//기초자산 전일 대비
CString strUNAS_PRDY_VRSS_CLR = m_CommAgent.GetRealOutputData("F40", "UNAS_PRDY_VRSS_CLR");		//[UNAS_PRDY_VRSS]색참조(+상승, -하락)
CString strUNAS_PRDY_CTRT = m_CommAgent.GetRealOutputData("F40", "UNAS_PRDY_CTRT");		//기초자산 전일 대비율
CString strUNAS_PRDY_CTRT_CLR = m_CommAgent.GetRealOutputData("F40", "UNAS_PRDY_CTRT_CLR");		//[UNAS_PRDY_CTRT]색참조(+상승, -하락)
CString strCNTG_PRGS = m_CommAgent.GetRealOutputData("F40", "CNTG_PRGS");		//체결틱추이
