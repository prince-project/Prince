BEGIN_FUNCTION_MAP
	REAL_TYPE=223, REAL_NAME=EF5, DESCRIPTION=야간선물옵션체결통보;
	BEGIN_DATA_MAP
	begin
			 ...
			 INDEX=31, ITEM=sDvrsExcgDcd, TYPE=string, SIZE=2, KEY=0, CAPTION=파생상품거래소구분코드, FID=0;
			 INDEX=32, ITEM=sFiller, TYPE=string, SIZE=29, KEY=0, CAPTION=Filler, FID=0;
	end
	END_DATA_MAP
END_FUNCTION_MAP
...
CString strsDvrsExcgDcd = realCommRecvData.GetItem(0, 31);		//파생상품거래소구분코드
CString strsFiller = realCommRecvData.GetItem(0, 32);		//Filler
