BEGIN_FUNCTION_MAP
	REAL_TYPE=39, REAL_NAME=O41, DESCRIPTION=위클리옵션호가;
	BEGIN_DATA_MAP
	begin
 ...
 **********************************************/
CString strSHRN_ISCD = m_CommAgent.GetRealOutputData("O41", "SHRN_ISCD");		//종목코드
CString strBSOP_HOUR = m_CommAgent.GetRealOutputData("O41", "BSOP_HOUR");		//호가시간
CString strASKP1 = m_CommAgent.GetRealOutputData("O41", "ASKP1");		//1매도호가
CString strASKP1_CLR = m_CommAgent.GetRealOutputData("O41", "ASKP1_CLR");		//[ASKP1]색참조(+상승, -하락)
CString strASKP2 = m_CommAgent.GetRealOutputData("O41", "ASKP2");		//2매도호가
CString strASKP2_CLR = m_CommAgent.GetRealOutputData("O41", "ASKP2_CLR");		//[ASKP2]색참조(+상승, -하락)
CString strASKP3 = m_CommAgent.GetRealOutputData("O41", "ASKP3");		//3매도호가
CString strASKP3_CLR = m_CommAgent.GetRealOutputData("O41", "ASKP3_CLR");		//[ASKP3]색참조(+상승, -하락)
CString strASKP4 = m_CommAgent.GetRealOutputData("O41", "ASKP4");		//4매도호가
CString strASKP4_CLR = m_CommAgent.GetRealOutputData("O41", "ASKP4_CLR");		//[ASKP4]색참조(+상승, -하락)
CString strASKP5 = m_CommAgent.GetRealOutputData("O41", "ASKP5");		//5매도호가
CString strASKP5_CLR = m_CommAgent.GetRealOutputData("O41", "ASKP5_CLR");		//[ASKP5]색참조(+상승, -하락)
CString strBIDP1 = m_CommAgent.GetRealOutputData("O41", "BIDP1");		//1매수호가
CString strBIDP1_CLR = m_CommAgent.GetRealOutputData("O41", "BIDP1_CLR");		//[BIDP1]색참조(+상승, -하락)
CString strBIDP2 = m_CommAgent.GetRealOutputData("O41", "BIDP2");		//2매수호가
CString strBIDP2_CLR = m_CommAgent.GetRealOutputData("O41", "BIDP2_CLR");		//[BIDP2]색참조(+상승, -하락)
CString strBIDP3 = m_CommAgent.GetRealOutputData("O41", "BIDP3");		//3매수호가
CString strBIDP3_CLR = m_CommAgent.GetRealOutputData("O41", "BIDP3_CLR");		//[BIDP3]색참조(+상승, -하락)
CString strBIDP4 = m_CommAgent.GetRealOutputData("O41", "BIDP4");		//4매수호가
CString strBIDP4_CLR = m_CommAgent.GetRealOutputData("O41", "BIDP4_CLR");		//[BIDP4]색참조(+상승, -하락)
CString strBIDP5 = m_CommAgent.GetRealOutputData("O41", "BIDP5");		//5매수호가
CString strBIDP5_CLR = m_CommAgent.GetRealOutputData("O41", "BIDP5_CLR");		//[BIDP5]색참조(+상승, -하락)
CString strASKP_CSNU1 = m_CommAgent.GetRealOutputData("O41", "ASKP_CSNU1");		//1매도호가 건수
CString strASKP_CSNU2 = m_CommAgent.GetRealOutputData("O41", "ASKP_CSNU2");		//2매도호가 건수
CString strASKP_CSNU3 = m_CommAgent.GetRealOutputData("O41", "ASKP_CSNU3");		//3매도호가 건수
CString strASKP_CSNU4 = m_CommAgent.GetRealOutputData("O41", "ASKP_CSNU4");		//4매도호가 건수
CString strASKP_CSNU5 = m_CommAgent.GetRealOutputData("O41", "ASKP_CSNU5");		//5매도호가 건수
CString strBIDP_CSNU1 = m_CommAgent.GetRealOutputData("O41", "BIDP_CSNU1");		//1매수호가 건수
CString strBIDP_CSNU2 = m_CommAgent.GetRealOutputData("O41", "BIDP_CSNU2");		//2매수호가 건수
CString strBIDP_CSNU3 = m_CommAgent.GetRealOutputData("O41", "BIDP_CSNU3");		//3매수호가 건수
CString strBIDP_CSNU4 = m_CommAgent.GetRealOutputData("O41", "BIDP_CSNU4");		//4매수호가 건수
CString strBIDP_CSNU5 = m_CommAgent.GetRealOutputData("O41", "BIDP_CSNU5");		//5매수호가 건수
CString strASKP_RSQN1 = m_CommAgent.GetRealOutputData("O41", "ASKP_RSQN1");		//1매도호가 잔량
CString strASKP_RSQN2 = m_CommAgent.GetRealOutputData("O41", "ASKP_RSQN2");		//2매도호가 잔량
CString strASKP_RSQN3 = m_CommAgent.GetRealOutputData("O41", "ASKP_RSQN3");		//3매도호가 잔량
CString strASKP_RSQN4 = m_CommAgent.GetRealOutputData("O41", "ASKP_RSQN4");		//4매도호가 잔량
CString strASKP_RSQN5 = m_CommAgent.GetRealOutputData("O41", "ASKP_RSQN5");		//5매도호가 잔량
CString strBIDP_RSQN1 = m_CommAgent.GetRealOutputData("O41", "BIDP_RSQN1");		//1매수호가 잔량
CString strBIDP_RSQN2 = m_CommAgent.GetRealOutputData("O41", "BIDP_RSQN2");		//2매수호가 잔량
CString strBIDP_RSQN3 = m_CommAgent.GetRealOutputData("O41", "BIDP_RSQN3");		//3매수호가 잔량
CString strBIDP_RSQN4 = m_CommAgent.GetRealOutputData("O41", "BIDP_RSQN4");		//4매수호가 잔량
CString strBIDP_RSQN5 = m_CommAgent.GetRealOutputData("O41", "BIDP_RSQN5");		//5매수호가 잔량
CString strTOTAL_ASKP_CSNU = m_CommAgent.GetRealOutputData("O41", "TOTAL_ASKP_CSNU");		//총 매도호가 건수
CString strTOTAL_BIDP_CSNU = m_CommAgent.GetRealOutputData("O41", "TOTAL_BIDP_CSNU");		//총 매수호가 건수
CString strTOTAL_ASKP_RSQN = m_CommAgent.GetRealOutputData("O41", "TOTAL_ASKP_RSQN");		//총 매도호가 잔량
CString strTOTAL_BIDP_RSQN = m_CommAgent.GetRealOutputData("O41", "TOTAL_BIDP_RSQN");		//총 매수호가 잔량
CString strANTC_CNPR = m_CommAgent.GetRealOutputData("O41", "ANTC_CNPR");		//예상 체결 가격
CString strANTC_CNPR_CLR = m_CommAgent.GetRealOutputData("O41", "ANTC_CNPR_CLR");		//[ANTC_CNPR]색참조(+상승, -하락)
CString strANTC_CLS_CODE = m_CommAgent.GetRealOutputData("O41", "ANTC_CLS_CODE");		//예상구분코드
