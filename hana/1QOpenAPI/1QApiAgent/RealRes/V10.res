BEGIN_FUNCTION_MAP
	REAL_TYPE=132, REAL_NAME=V10, DESCRIPTION=해외선물 체결;
	BEGIN_DATA_MAP
	begin
			 INDEX=0, ITEM=PRDT_CD, TYPE=string, SIZE=15, KEY=1, CAPTION=종목코드(내부), FID=0;
			 INDEX=1, ITEM=TR_DT, TYPE=string, SIZE=8, KEY=0, CAPTION=현영업일, 거래일자, FID=0;
 ...
 **********************************************/
CString strPRDT_CD = m_CommAgent.GetRealOutputData("V10", "PRDT_CD");		//종목코드(내부)
CString strTR_DT = m_CommAgent.GetRealOutputData("V10", "TR_DT");		//현영업일, 거래일자
CString strTRADE_DATE = m_CommAgent.GetRealOutputData("V10", "TRADE_DATE");		//일자
CString strTRADE_TIME = m_CommAgent.GetRealOutputData("V10", "TRADE_TIME");		//시간
CString strKTRADE_DATE = m_CommAgent.GetRealOutputData("V10", "KTRADE_DATE");		//한국일자
CString strKTRADE_TIME = m_CommAgent.GetRealOutputData("V10", "KTRADE_TIME");		//한국시간
CString strRPT_SEQ = m_CommAgent.GetRealOutputData("V10", "RPT_SEQ");		//seq
CString strGLOBEX_TP = m_CommAgent.GetRealOutputData("V10", "GLOBEX_TP");		//전산장구분
CString strTRDPRC_1 = m_CommAgent.GetRealOutputData("V10", "TRDPRC_1");		//현재가
CString strTRDPRC_1_CLR = m_CommAgent.GetRealOutputData("V10", "TRDPRC_1_CLR");		//[TRDPRC_1]색참조(+상승, -하락)
CString strNETCHNG_CLS = m_CommAgent.GetRealOutputData("V10", "NETCHNG_CLS");		//전일대비구분
CString strNETCHNG_1 = m_CommAgent.GetRealOutputData("V10", "NETCHNG_1");		//전일대비
CString strNETCHNG_1_CLR = m_CommAgent.GetRealOutputData("V10", "NETCHNG_1_CLR");		//[NETCHNG_1]색참조(+상승, -하락)
CString strPCTCHNG_1 = m_CommAgent.GetRealOutputData("V10", "PCTCHNG_1");		//전일대비율
CString strPCTCHNG_1_CLR = m_CommAgent.GetRealOutputData("V10", "PCTCHNG_1_CLR");		//[PCTCHNG_1]색참조(+상승, -하락)
CString strTRDVOL_1 = m_CommAgent.GetRealOutputData("V10", "TRDVOL_1");		//체결수량
CString strTRDVOL_1_CLR = m_CommAgent.GetRealOutputData("V10", "TRDVOL_1_CLR");		//[TRDVOL_1]색참조(+상승, -하락)
CString strACVOL_1 = m_CommAgent.GetRealOutputData("V10", "ACVOL_1");		//누적체결수량
CString strOPEN_PRC = m_CommAgent.GetRealOutputData("V10", "OPEN_PRC");		//시가
CString strOPEN_PRC_CLR = m_CommAgent.GetRealOutputData("V10", "OPEN_PRC_CLR");		//[OPEN_PRC]색참조(+상승, -하락)
CString strHIGH_1 = m_CommAgent.GetRealOutputData("V10", "HIGH_1");		//고가
CString strHIGH_1_CLR = m_CommAgent.GetRealOutputData("V10", "HIGH_1_CLR");		//[HIGH_1]색참조(+상승, -하락)
CString strLOW_1 = m_CommAgent.GetRealOutputData("V10", "LOW_1");		//저가
CString strLOW_1_CLR = m_CommAgent.GetRealOutputData("V10", "LOW_1_CLR");		//[LOW_1]색참조(+상승, -하락)
CString strOPEN_TIME = m_CommAgent.GetRealOutputData("V10", "OPEN_TIME");		//시가시간
CString strHIGH_TIME = m_CommAgent.GetRealOutputData("V10", "HIGH_TIME");		//고가시간
CString strLOW_TIME = m_CommAgent.GetRealOutputData("V10", "LOW_TIME");		//저가시간
CString strBID_EXEC_SUM = m_CommAgent.GetRealOutputData("V10", "BID_EXEC_SUM");		//당일 누적체결수량(매수성향)
CString strASK_EXEC_SUM = m_CommAgent.GetRealOutputData("V10", "ASK_EXEC_SUM");		//당일 누적체결수량(매도성향)
CString strBOH_EXEC_SUM = m_CommAgent.GetRealOutputData("V10", "BOH_EXEC_SUM");		//당일 누적체결수량(보합)
CString strEX_BEST_BID1 = m_CommAgent.GetRealOutputData("V10", "EX_BEST_BID1");		//체결시 매수 1호가(거래소)
CString strEX_BEST_BID1_CLR = m_CommAgent.GetRealOutputData("V10", "EX_BEST_BID1_CLR");		//[EX_BEST_BID1]색참조(+상승, -하락)
CString strEX_BEST_ASK1 = m_CommAgent.GetRealOutputData("V10", "EX_BEST_ASK1");		//체결시 매도 1호가(거래소)
CString strEX_BEST_ASK1_CLR = m_CommAgent.GetRealOutputData("V10", "EX_BEST_ASK1_CLR");		//[EX_BEST_ASK1]색참조(+상승, -하락)
CString strEX_BEST_BSIZ1 = m_CommAgent.GetRealOutputData("V10", "EX_BEST_BSIZ1");		//체결시 매수 1수량(거래소)
CString strEX_BEST_ASIZ1 = m_CommAgent.GetRealOutputData("V10", "EX_BEST_ASIZ1");		//체결시 매도 1수량(거래소)
CString strOPENINTEREST = m_CommAgent.GetRealOutputData("V10", "OPENINTEREST");		//미결제량
CString strOP_NETCHNG_1 = m_CommAgent.GetRealOutputData("V10", "OP_NETCHNG_1");		//미체결량대비
...
CString strTR_DT = realCommRecvData.GetItem(0, 1);		//현영업일, 거래일자
