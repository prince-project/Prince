BEGIN_FUNCTION_MAP
	REAL_TYPE=38, REAL_NAME=O40, DESCRIPTION=위클리옵션체결;
	BEGIN_DATA_MAP
	begin
 ...
 **********************************************/
CString strSHRN_ISCD = m_CommAgent.GetRealOutputData("O40", "SHRN_ISCD");		//종목 코드
CString strBSOP_DATE = m_CommAgent.GetRealOutputData("O40", "BSOP_DATE");		//실시간일자
CString strBSOP_HOUR = m_CommAgent.GetRealOutputData("O40", "BSOP_HOUR");		//체결 시간
CString strPRPR = m_CommAgent.GetRealOutputData("O40", "PRPR");		//현재가
CString strPRPR_CLR = m_CommAgent.GetRealOutputData("O40", "PRPR_CLR");		//[PRPR]색참조(+상승, -하락)
CString strPRDY_VRSS_SIGN = m_CommAgent.GetRealOutputData("O40", "PRDY_VRSS_SIGN");		//전일 대비 부호
CString strPRDY_VRSS = m_CommAgent.GetRealOutputData("O40", "PRDY_VRSS");		//전일 대비
CString strPRDY_VRSS_CLR = m_CommAgent.GetRealOutputData("O40", "PRDY_VRSS_CLR");		//[PRDY_VRSS]색참조(+상승, -하락)
CString strPRDY_CTRT = m_CommAgent.GetRealOutputData("O40", "PRDY_CTRT");		//전일 대비율
CString strPRDY_CTRT_CLR = m_CommAgent.GetRealOutputData("O40", "PRDY_CTRT_CLR");		//[PRDY_CTRT]색참조(+상승, -하락)
CString strCNTG_VOL = m_CommAgent.GetRealOutputData("O40", "CNTG_VOL");		//체결 거래량
CString strCNTG_VOL_CLR = m_CommAgent.GetRealOutputData("O40", "CNTG_VOL_CLR");		//[CNTG_VOL]색참조(+상승, -하락)
CString strCNTG_CLS_CODE = m_CommAgent.GetRealOutputData("O40", "CNTG_CLS_CODE");		//체결 구분 코드
CString strACML_VOL = m_CommAgent.GetRealOutputData("O40", "ACML_VOL");		//누적 거래량
CString strACML_TR_PBMN = m_CommAgent.GetRealOutputData("O40", "ACML_TR_PBMN");		//누적 거래 대금
CString strOPRC = m_CommAgent.GetRealOutputData("O40", "OPRC");		//시가
CString strOPRC_CLR = m_CommAgent.GetRealOutputData("O40", "OPRC_CLR");		//[OPRC]색참조(+상승, -하락)
CString strHGPR = m_CommAgent.GetRealOutputData("O40", "HGPR");		//고가
CString strHGPR_CLR = m_CommAgent.GetRealOutputData("O40", "HGPR_CLR");		//[HGPR]색참조(+상승, -하락)
CString strLWPR = m_CommAgent.GetRealOutputData("O40", "LWPR");		//저가
CString strLWPR_CLR = m_CommAgent.GetRealOutputData("O40", "LWPR_CLR");		//[LWPR]색참조(+상승, -하락)
CString strASKP1 = m_CommAgent.GetRealOutputData("O40", "ASKP1");		//매도호가1
CString strASKP1_CLR = m_CommAgent.GetRealOutputData("O40", "ASKP1_CLR");		//[ASKP1]색참조(+상승, -하락)
CString strBIDP1 = m_CommAgent.GetRealOutputData("O40", "BIDP1");		//매수호가1
CString strBIDP1_CLR = m_CommAgent.GetRealOutputData("O40", "BIDP1_CLR");		//[BIDP1]색참조(+상승, -하락)
CString strOTST_STPL_QTY = m_CommAgent.GetRealOutputData("O40", "OTST_STPL_QTY");		//미결제 약정 수량
CString strDELTA = m_CommAgent.GetRealOutputData("O40", "DELTA");		//델타
CString strGAMA = m_CommAgent.GetRealOutputData("O40", "GAMA");		//감마
CString strVEGA = m_CommAgent.GetRealOutputData("O40", "VEGA");		//베가
CString strTHETA = m_CommAgent.GetRealOutputData("O40", "THETA");		//세타
CString strRHO = m_CommAgent.GetRealOutputData("O40", "RHO");		//로
CString strTHPR = m_CommAgent.GetRealOutputData("O40", "THPR");		//이론가
CString strINTS_VLTL_PRPR = m_CommAgent.GetRealOutputData("O40", "INTS_VLTL_PRPR");		//내재변동성_현재가
CString strINTS_VLTL_ASKP = m_CommAgent.GetRealOutputData("O40", "INTS_VLTL_ASKP");		//내재변동성_매도호가
CString strINTS_VLTL_BIDP = m_CommAgent.GetRealOutputData("O40", "INTS_VLTL_BIDP");		//내재변동성_매수호가
CString strOTST_STPL_QTY_ICDC = m_CommAgent.GetRealOutputData("O40", "OTST_STPL_QTY_ICDC");		//미결제 약정 수량 증감
CString strOTST_STPL_QTY_ICDC_CLR = m_CommAgent.GetRealOutputData("O40", "OTST_STPL_QTY_ICDC_CLR");		//[OTST_STPL_QTY_ICDC]색참조(+상승, -하락)
CString strDYNMC_UPLMTPRC = m_CommAgent.GetRealOutputData("O40", "DYNMC_UPLMTPRC");		//실시간상한가
CString strDYNMC_LWLMTPRC = m_CommAgent.GetRealOutputData("O40", "DYNMC_LWLMTPRC");		//실시간하한
CString strANTC_NMIX_CLS_CODE = m_CommAgent.GetRealOutputData("O40", "ANTC_NMIX_CLS_CODE");		//예상지수구분코드
CString strOTST_STPL_QTY_REF_IC = m_CommAgent.GetRealOutputData("O40", "OTST_STPL_QTY_REF_IC");		//미결제약정수량직전증감
CString strOTST_STPL_QTY_REF_IC_CLR = m_CommAgent.GetRealOutputData("O40", "OTST_STPL_QTY_REF_IC_CLR");		//[OTST_STPL_QTY_REF_IC]색참조(+상승, -하락)
CString strINTS_WRTH = m_CommAgent.GetRealOutputData("O40", "INTS_WRTH");		//내재가치
CString strTIME_WRTH = m_CommAgent.GetRealOutputData("O40", "TIME_WRTH");		//시간가치
CString strESDG = m_CommAgent.GetRealOutputData("O40", "ESDG");		//괴리도
CString strESDG_CLR = m_CommAgent.GetRealOutputData("O40", "ESDG_CLR");		//[ESDG]색참조(+상승, -하락)
CString strDPRT = m_CommAgent.GetRealOutputData("O40", "DPRT");		//괴리율
CString strDPRT_CLR = m_CommAgent.GetRealOutputData("O40", "DPRT_CLR");		//[DPRT]색참조(+상승, -하락)
CString strCNTG_PRGS = m_CommAgent.GetRealOutputData("O40", "CNTG_PRGS");		//체결틱추이
CString strASPR_RAISE_SIGN = m_CommAgent.GetRealOutputData("O40", "ASPR_RAISE_SIGN");		//호가상향부호
CString strRGBF_ANTC_SDPR = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_SDPR");		//전예상기준가
CString strRGBF_ANTC_SDPR_CLR = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_SDPR_CLR");		//[RGBF_ANTC_SDPR]색참조(+상승, -하락)
CString strRGBF_ANTC_VRSS_SIGN = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_VRSS_SIGN");		//직전예상대비부호
CString strRGBF_ANTC_VRSS = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_VRSS");		//직전예상대비
CString strRGBF_ANTC_VRSS_CLR = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_VRSS_CLR");		//[RGBF_ANTC_VRSS]색참조(+상승, -하락)
CString strRGBF_ANTC_CTRT = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_CTRT");		//직전예상대비율
CString strRGBF_ANTC_CTRT_CLR = m_CommAgent.GetRealOutputData("O40", "RGBF_ANTC_CTRT_CLR");		//[RGBF_ANTC_CTRT]색참조(+상승, -하락)
