BEGIN_FUNCTION_MAP
	REAL_TYPE=37, REAL_NAME=O21, DESCRIPTION=주식옵션호가;
	BEGIN_DATA_MAP
	begin
 ...
 **********************************************/
CString strSHRN_ISCD = m_CommAgent.GetRealOutputData("O21", "SHRN_ISCD");		//종목코드
CString strBSOP_HOUR = m_CommAgent.GetRealOutputData("O21", "BSOP_HOUR");		//호가시간
CString strASKP1 = m_CommAgent.GetRealOutputData("O21", "ASKP1");		//1매도호가
CString strASKP1_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP1_CLR");		//[ASKP1]색참조(+상승, -하락)
CString strASKP2 = m_CommAgent.GetRealOutputData("O21", "ASKP2");		//2매도호가
CString strASKP2_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP2_CLR");		//[ASKP2]색참조(+상승, -하락)
CString strASKP3 = m_CommAgent.GetRealOutputData("O21", "ASKP3");		//3매도호가
CString strASKP3_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP3_CLR");		//[ASKP3]색참조(+상승, -하락)
CString strASKP4 = m_CommAgent.GetRealOutputData("O21", "ASKP4");		//4매도호가
CString strASKP4_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP4_CLR");		//[ASKP4]색참조(+상승, -하락)
CString strASKP5 = m_CommAgent.GetRealOutputData("O21", "ASKP5");		//5매도호가
CString strASKP5_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP5_CLR");		//[ASKP5]색참조(+상승, -하락)
CString strASKP6 = m_CommAgent.GetRealOutputData("O21", "ASKP6");		//6매도호가
CString strASKP6_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP6_CLR");		//[ASKP6]색참조(+상승, -하락)
CString strASKP7 = m_CommAgent.GetRealOutputData("O21", "ASKP7");		//7매도호가
CString strASKP7_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP7_CLR");		//[ASKP7]색참조(+상승, -하락)
CString strASKP8 = m_CommAgent.GetRealOutputData("O21", "ASKP8");		//8매도호가
CString strASKP8_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP8_CLR");		//[ASKP8]색참조(+상승, -하락)
CString strASKP9 = m_CommAgent.GetRealOutputData("O21", "ASKP9");		//9매도호가
CString strASKP9_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP9_CLR");		//[ASKP9]색참조(+상승, -하락)
CString strASKP10 = m_CommAgent.GetRealOutputData("O21", "ASKP10");		//10매도호가
CString strASKP10_CLR = m_CommAgent.GetRealOutputData("O21", "ASKP10_CLR");		//[ASKP10]색참조(+상승, -하락)
CString strBIDP1 = m_CommAgent.GetRealOutputData("O21", "BIDP1");		//1매수호가
CString strBIDP1_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP1_CLR");		//[BIDP1]색참조(+상승, -하락)
CString strBIDP2 = m_CommAgent.GetRealOutputData("O21", "BIDP2");		//2매수호가
CString strBIDP2_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP2_CLR");		//[BIDP2]색참조(+상승, -하락)
CString strBIDP3 = m_CommAgent.GetRealOutputData("O21", "BIDP3");		//3매수호가
CString strBIDP3_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP3_CLR");		//[BIDP3]색참조(+상승, -하락)
CString strBIDP4 = m_CommAgent.GetRealOutputData("O21", "BIDP4");		//4매수호가
CString strBIDP4_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP4_CLR");		//[BIDP4]색참조(+상승, -하락)
CString strBIDP5 = m_CommAgent.GetRealOutputData("O21", "BIDP5");		//5매수호가
CString strBIDP5_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP5_CLR");		//[BIDP5]색참조(+상승, -하락)
CString strBIDP6 = m_CommAgent.GetRealOutputData("O21", "BIDP6");		//6매수호가
CString strBIDP6_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP6_CLR");		//[BIDP6]색참조(+상승, -하락)
CString strBIDP7 = m_CommAgent.GetRealOutputData("O21", "BIDP7");		//7매수호가
CString strBIDP7_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP7_CLR");		//[BIDP7]색참조(+상승, -하락)
CString strBIDP8 = m_CommAgent.GetRealOutputData("O21", "BIDP8");		//8매수호가
CString strBIDP8_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP8_CLR");		//[BIDP8]색참조(+상승, -하락)
CString strBIDP9 = m_CommAgent.GetRealOutputData("O21", "BIDP9");		//9매수호가
CString strBIDP9_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP9_CLR");		//[BIDP9]색참조(+상승, -하락)
CString strBIDP10 = m_CommAgent.GetRealOutputData("O21", "BIDP10");		//10매수호가
CString strBIDP10_CLR = m_CommAgent.GetRealOutputData("O21", "BIDP10_CLR");		//[BIDP10]색참조(+상승, -하락)
CString strASKP_RSQN1 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN1");		//1매도호가 잔량
CString strASKP_RSQN2 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN2");		//2매도호가 잔량
CString strASKP_RSQN3 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN3");		//3매도호가 잔량
CString strASKP_RSQN4 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN4");		//4매도호가 잔량
CString strASKP_RSQN5 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN5");		//5매도호가 잔량
CString strASKP_RSQN6 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN6");		//6매도호가 잔량
CString strASKP_RSQN7 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN7");		//7매도호가 잔량
CString strASKP_RSQN8 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN8");		//8매도호가 잔량
CString strASKP_RSQN9 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN9");		//9매도호가 잔량
CString strASKP_RSQN10 = m_CommAgent.GetRealOutputData("O21", "ASKP_RSQN10");		//10매도호가 잔량
CString strBIDP_RSQN1 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN1");		//1매수호가 잔량
CString strBIDP_RSQN2 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN2");		//2매수호가 잔량
CString strBIDP_RSQN3 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN3");		//3매수호가 잔량
CString strBIDP_RSQN4 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN4");		//4매수호가 잔량
CString strBIDP_RSQN5 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN5");		//5매수호가 잔량
CString strBIDP_RSQN6 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN6");		//6매수호가 잔량
CString strBIDP_RSQN7 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN7");		//7매수호가 잔량
CString strBIDP_RSQN8 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN8");		//8매수호가 잔량
CString strBIDP_RSQN9 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN9");		//9매수호가 잔량
CString strBIDP_RSQN10 = m_CommAgent.GetRealOutputData("O21", "BIDP_RSQN10");		//10매수호가 잔량
CString strASKP_CSNU1 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU1");		//1매도호가 건수
CString strASKP_CSNU2 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU2");		//2매도호가 건수
CString strASKP_CSNU3 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU3");		//3매도호가 건수
CString strASKP_CSNU4 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU4");		//4매도호가 건수
CString strASKP_CSNU5 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU5");		//5매도호가 건수
CString strASKP_CSNU6 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU6");		//6매도호가 건수
CString strASKP_CSNU7 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU7");		//7매도호가 건수
CString strASKP_CSNU8 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU8");		//8매도호가 건수
CString strASKP_CSNU9 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU9");		//9매도호가 건수
CString strASKP_CSNU10 = m_CommAgent.GetRealOutputData("O21", "ASKP_CSNU10");		//10매도호가 건수
CString strBIDP_CSNU1 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU1");		//1매수호가 건수
CString strBIDP_CSNU2 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU2");		//2매수호가 건수
CString strBIDP_CSNU3 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU3");		//3매수호가 건수
CString strBIDP_CSNU4 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU4");		//4매수호가 건수
CString strBIDP_CSNU5 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU5");		//5매수호가 건수
CString strBIDP_CSNU6 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU6");		//6매수호가 건수
CString strBIDP_CSNU7 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU7");		//7매수호가 건수
CString strBIDP_CSNU8 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU8");		//8매수호가 건수
CString strBIDP_CSNU9 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU9");		//9매수호가 건수
CString strBIDP_CSNU10 = m_CommAgent.GetRealOutputData("O21", "BIDP_CSNU10");		//10매수호가 건수
CString strTOTAL_ASKP_CSNU = m_CommAgent.GetRealOutputData("O21", "TOTAL_ASKP_CSNU");		//총 매도호가 건수
CString strTOTAL_BIDP_CSNU = m_CommAgent.GetRealOutputData("O21", "TOTAL_BIDP_CSNU");		//총 매수호가 건수
CString strTOTAL_ASKP_RSQN = m_CommAgent.GetRealOutputData("O21", "TOTAL_ASKP_RSQN");		//총 매도호가 잔량
CString strTOTAL_BIDP_RSQN = m_CommAgent.GetRealOutputData("O21", "TOTAL_BIDP_RSQN");		//총 매수호가 잔량
CString strANTC_CNPR = m_CommAgent.GetRealOutputData("O21", "ANTC_CNPR");		//예상 체결 가격
CString strANTC_CNPR_CLR = m_CommAgent.GetRealOutputData("O21", "ANTC_CNPR_CLR");		//[ANTC_CNPR]색참조(+상승, -하락)
CString strANTC_CLS_CODE = m_CommAgent.GetRealOutputData("O21", "ANTC_CLS_CODE");		//예상구분코드
