BEGIN_FUNCTION_MAP
	REAL_TYPE=224, REAL_NAME=CF0, DESCRIPTION=CFD체결통보;
	BEGIN_DATA_MAP
	begin
			 ...
			 INDEX=24, ITEM=sOrdTypeGbNm, TYPE=string, SIZE=8, KEY=0, CAPTION=CFD주문유형구분명, FID=0;
			 ...
			 INDEX=43, ITEM=sRejectInfo, TYPE=string, SIZE=200, KEY=0, CAPTION=거부사유내용, FID=0;
			 INDEX=44, ITEM=sCFDBrokerCd, TYPE=string, SIZE=20, KEY=0, CAPTION=CFD브로커코드, FID=0;
			 INDEX=45, ITEM=sFiller, TYPE=string, SIZE=94, KEY=0, CAPTION=Reservation Area, FID=0;
	end
	END_DATA_MAP
END_FUNCTION_MAP
 ...
 **********************************************/
CString strsMrktGroup = m_CommAgent.GetRealOutputData("CF0", "sMrktGroup");		//시장그룹
CString strsDataType = m_CommAgent.GetRealOutputData("CF0", "sDataType");		//데이터구분
CString strsComCode = m_CommAgent.GetRealOutputData("CF0", "sComCode");		//매체 구분
CString strsUserID = m_CommAgent.GetRealOutputData("CF0", "sUserID");		//사용자 ID
CString strsCtno = m_CommAgent.GetRealOutputData("CF0", "sCtno");		//계좌대체번호
CString strsAcctNo = m_CommAgent.GetRealOutputData("CF0", "sAcctNo");		//계좌번호
CString strsAcctName = m_CommAgent.GetRealOutputData("CF0", "sAcctName");		//계좌명
CString strsProcTime = m_CommAgent.GetRealOutputData("CF0", "sProcTime");		//접수시간
CString strsOrdDt = m_CommAgent.GetRealOutputData("CF0", "sOrdDt");		//주문일자
CString strsOrdNo = m_CommAgent.GetRealOutputData("CF0", "sOrdNo");		//주문번호
CString strsOrgOrdNo = m_CommAgent.GetRealOutputData("CF0", "sOrgOrdNo");		//원주문번호
CString strsItemCode = m_CommAgent.GetRealOutputData("CF0", "sItemCode");		//단축종목코드
CString strsItemName = m_CommAgent.GetRealOutputData("CF0", "sItemName");		//종목명
CString strsBidCode = m_CommAgent.GetRealOutputData("CF0", "sBidCode");		//매도매수구분
CString strsBidCodeName = m_CommAgent.GetRealOutputData("CF0", "sBidCodeName");		//매도매수구분명
CString strsModType = m_CommAgent.GetRealOutputData("CF0", "sModType");		//정정취소구분
CString strsOrdQty = m_CommAgent.GetRealOutputData("CF0", "sOrdQty");		//주문수량
CString strsOrdPrice = m_CommAgent.GetRealOutputData("CF0", "sOrdPrice");		//주문가격
CString strsTotContQty = m_CommAgent.GetRealOutputData("CF0", "sTotContQty");		//총체결수량
CString strsAvgContPrice = m_CommAgent.GetRealOutputData("CF0", "sAvgContPrice");		//평균체결가격
CString strsUnContQty = m_CommAgent.GetRealOutputData("CF0", "sUnContQty");		//미체결수량
CString strsContAmt = m_CommAgent.GetRealOutputData("CF0", "sContAmt");		//체결금액
CString strsCreditType = m_CommAgent.GetRealOutputData("CF0", "sCreditType");		//신용구분
CString strsCreditLoanDate = m_CommAgent.GetRealOutputData("CF0", "sCreditLoanDate");		//신용대출일
CString strsOrdTypeGbNm = m_CommAgent.GetRealOutputData("CF0", "sOrdTypeGbNm");		//CFD주문유형구분명
CString strsOrdStatName = m_CommAgent.GetRealOutputData("CF0", "sOrdStatName");		//주문상태
CString strsOrdTpName = m_CommAgent.GetRealOutputData("CF0", "sOrdTpName");		//주문구분명
CString strsOrdTime = m_CommAgent.GetRealOutputData("CF0", "sOrdTime");		//주문시각
CString strsCntrTime = m_CommAgent.GetRealOutputData("CF0", "sCntrTime");		//체결시각
CString strsLocOrdTime = m_CommAgent.GetRealOutputData("CF0", "sLocOrdTime");		//현지주문시각
CString strsLocCntrTime = m_CommAgent.GetRealOutputData("CF0", "sLocCntrTime");		//현지체결시각
CString strsOrdPriceTp = m_CommAgent.GetRealOutputData("CF0", "sOrdPriceTp");		//주문유형
CString strsOrdPriceTpName = m_CommAgent.GetRealOutputData("CF0", "sOrdPriceTpName");		//주문유형명
CString strsOrdCond = m_CommAgent.GetRealOutputData("CF0", "sOrdCond");		//주문조건
CString strsOrdCondName = m_CommAgent.GetRealOutputData("CF0", "sOrdCondName");		//주문조건명
CString strsInvInfMktDcd = m_CommAgent.GetRealOutputData("CF0", "sInvInfMktDcd");		//해외주식시장구분코드
CString strsOsMrktCd = m_CommAgent.GetRealOutputData("CF0", "sOsMrktCd");		//해외시장코드
CString strsOsMrktName = m_CommAgent.GetRealOutputData("CF0", "sOsMrktName");		//해외시장명
CString strsCurrency = m_CommAgent.GetRealOutputData("CF0", "sCurrency");		//거래통화
CString strsOrdMediaName = m_CommAgent.GetRealOutputData("CF0", "sOrdMediaName");		//주문매체명
CString strsOrdMembName = m_CommAgent.GetRealOutputData("CF0", "sOrdMembName");		//주문자명
CString strsContQty = m_CommAgent.GetRealOutputData("CF0", "sContQty");		//체결수량
CString strsContPrice = m_CommAgent.GetRealOutputData("CF0", "sContPrice");		//체결가격
CString strsRejectInfo = m_CommAgent.GetRealOutputData("CF0", "sRejectInfo");		//거부사유내용
CString strsCFDBrokerCd = m_CommAgent.GetRealOutputData("CF0", "sCFDBrokerCd");		//CFD브로커코드
CString strsFiller = m_CommAgent.GetRealOutputData("CF0", "sFiller");		//Reservation Area
...
CString strsOrdTypeGbNm = realCommRecvData.GetItem(0, 24);		//CFD주문유형구분명
...
CString strsRejectInfo = realCommRecvData.GetItem(0, 43);		//거부사유내용
CString strsCFDBrokerCd = realCommRecvData.GetItem(0, 44);		//CFD브로커코드
CString strsFiller = realCommRecvData.GetItem(0, 45);		//Reservation Area
