BEGIN_FUNCTION_MAP
	REAL_TYPE=139, REAL_NAME=V21, DESCRIPTION=해외옵션 호가;
	BEGIN_DATA_MAP
	begin
 ...
 **********************************************/
CString strQTTN_PRDT_CD = m_CommAgent.GetRealOutputData("V21", "QTTN_PRDT_CD");		//종목코드(내부)
CString strQUOTE_DATE = m_CommAgent.GetRealOutputData("V21", "QUOTE_DATE");		//호가일자
CString strQUOTE_TIME = m_CommAgent.GetRealOutputData("V21", "QUOTE_TIME");		//호가시간
CString strKQUOTE_DATE = m_CommAgent.GetRealOutputData("V21", "KQUOTE_DATE");		//한국호가일자
CString strKQUOTE_TIME = m_CommAgent.GetRealOutputData("V21", "KQUOTE_TIME");		//한국호가시간
CString strRPT_SEQ = m_CommAgent.GetRealOutputData("V21", "RPT_SEQ");		//seq
CString strTRADE_SESSION_ID = m_CommAgent.GetRealOutputData("V21", "TRADE_SESSION_ID");		//장구분
CString strBEST_BID1 = m_CommAgent.GetRealOutputData("V21", "BEST_BID1");		//매수1호가
CString strBEST_BID1_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_BID1_CLR");		//[BEST_BID1]색참조(+상승, -하락)
CString strBEST_BSIZ1 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ1");		//매수1호가수량
CString strBEST_BCNT1 = m_CommAgent.GetRealOutputData("V21", "BEST_BCNT1");		//매수1호가건수
CString strBEST_BID2 = m_CommAgent.GetRealOutputData("V21", "BEST_BID2");		//매수2호가
CString strBEST_BID2_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_BID2_CLR");		//[BEST_BID2]색참조(+상승, -하락)
CString strBEST_BSIZ2 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ2");		//매수2호가수량
CString strBEST_BCNT2 = m_CommAgent.GetRealOutputData("V21", "BEST_BCNT2");		//메수2호가건수
CString strBEST_BID3 = m_CommAgent.GetRealOutputData("V21", "BEST_BID3");		//매수3호가
CString strBEST_BID3_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_BID3_CLR");		//[BEST_BID3]색참조(+상승, -하락)
CString strBEST_BSIZ3 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ3");		//매수3호가수량
CString strBEST_BCNT3 = m_CommAgent.GetRealOutputData("V21", "BEST_BCNT3");		//매수3호가건수
CString strBEST_BID4 = m_CommAgent.GetRealOutputData("V21", "BEST_BID4");		//매수4호가
CString strBEST_BID4_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_BID4_CLR");		//[BEST_BID4]색참조(+상승, -하락)
CString strBEST_BSIZ4 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ4");		//매수4호가수량
CString strBEST_BCNT4 = m_CommAgent.GetRealOutputData("V21", "BEST_BCNT4");		//매수4호가건수
CString strBEST_BID5 = m_CommAgent.GetRealOutputData("V21", "BEST_BID5");		//매수5호가
CString strBEST_BID5_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_BID5_CLR");		//[BEST_BID5]색참조(+상승, -하락)
CString strBEST_BSIZ5 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ5");		//매수5호가수량
CString strBEST_BCNT5 = m_CommAgent.GetRealOutputData("V21", "BEST_BCNT5");		//매수5호가건수
CString strBIDSIZE = m_CommAgent.GetRealOutputData("V21", "BIDSIZE");		//매수총호가수량
CString strBIDCNT = m_CommAgent.GetRealOutputData("V21", "BIDCNT");		//매수 전체건수
CString strBEST_ASK1 = m_CommAgent.GetRealOutputData("V21", "BEST_ASK1");		//매도1호가
CString strBEST_ASK1_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_ASK1_CLR");		//[BEST_ASK1]색참조(+상승, -하락)
CString strBEST_ASIZ1 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ1");		//매도1호가수량
CString strBEST_ACNT1 = m_CommAgent.GetRealOutputData("V21", "BEST_ACNT1");		//매도1호가건수
CString strBEST_ASK2 = m_CommAgent.GetRealOutputData("V21", "BEST_ASK2");		//매도2호가
CString strBEST_ASK2_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_ASK2_CLR");		//[BEST_ASK2]색참조(+상승, -하락)
CString strBEST_ASIZ2 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ2");		//매도2호가수량
CString strBEST_ACNT2 = m_CommAgent.GetRealOutputData("V21", "BEST_ACNT2");		//매도2호가건수
CString strBEST_ASK3 = m_CommAgent.GetRealOutputData("V21", "BEST_ASK3");		//매도3호가
CString strBEST_ASK3_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_ASK3_CLR");		//[BEST_ASK3]색참조(+상승, -하락)
CString strBEST_ASIZ3 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ3");		//매도3호가수량
CString strBEST_ACNT3 = m_CommAgent.GetRealOutputData("V21", "BEST_ACNT3");		//매도3호가건수
CString strBEST_ASK4 = m_CommAgent.GetRealOutputData("V21", "BEST_ASK4");		//매도4호가
CString strBEST_ASK4_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_ASK4_CLR");		//[BEST_ASK4]색참조(+상승, -하락)
CString strBEST_ASIZ4 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ4");		//매도4호가수량
CString strBEST_ACNT4 = m_CommAgent.GetRealOutputData("V21", "BEST_ACNT4");		//매도4호가건수
CString strBEST_ASK5 = m_CommAgent.GetRealOutputData("V21", "BEST_ASK5");		//매도5호가
CString strBEST_ASK5_CLR = m_CommAgent.GetRealOutputData("V21", "BEST_ASK5_CLR");		//[BEST_ASK5]색참조(+상승, -하락)
CString strBEST_ASIZ5 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ5");		//매도5호가수량
CString strBEST_ACNT5 = m_CommAgent.GetRealOutputData("V21", "BEST_ACNT5");		//매도5호가건수
CString strASKSIZE = m_CommAgent.GetRealOutputData("V21", "ASKSIZE");		//매도총호가수량
CString strASKCNT = m_CommAgent.GetRealOutputData("V21", "ASKCNT");		//매도 전체건수
CString strBID_ASK_SIZE_DIFF = m_CommAgent.GetRealOutputData("V21", "BID_ASK_SIZE_DIFF");		//매수매도 수량차
CString strBEST_BSIZ_ICDC1 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ_ICDC1");		//매수1호가수량 증감
CString strBEST_BSIZ_ICDC2 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ_ICDC2");		//매수2호가수량 증감
CString strBEST_BSIZ_ICDC3 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ_ICDC3");		//매수3호가수량 증감
CString strBEST_BSIZ_ICDC4 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ_ICDC4");		//매수4호가수량 증감
CString strBEST_BSIZ_ICDC5 = m_CommAgent.GetRealOutputData("V21", "BEST_BSIZ_ICDC5");		//매수5호가수량 증감
CString strBIDSIZE_ICDC = m_CommAgent.GetRealOutputData("V21", "BIDSIZE_ICDC");		//매수총호가수량 증감
CString strBEST_ASIZ_ICDC1 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ_ICDC1");		//매도1호가수량 증감
CString strBEST_ASIZ_ICDC2 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ_ICDC2");		//매도2호가수량 증감
CString strBEST_ASIZ_ICDC3 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ_ICDC3");		//매도3호가수량 증감
CString strBEST_ASIZ_ICDC4 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ_ICDC4");		//매도4호가수량 증감
CString strBEST_ASIZ_ICDC5 = m_CommAgent.GetRealOutputData("V21", "BEST_ASIZ_ICDC5");		//매도5호가수량 증감
CString strASKSIZE_ICDC = m_CommAgent.GetRealOutputData("V21", "ASKSIZE_ICDC");		//매도총호가수량 증감
CString strDATETIME = m_CommAgent.GetRealOutputData("V21", "DATETIME");		//수신시간
